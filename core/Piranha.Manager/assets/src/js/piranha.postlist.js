...
piranha.pagelist = new Vue({
    ...
    methods: {
        load: function () {
            var self = this;
            console.log(piranha.baseUrl + "manager/api/post/list");
            piranha.permissions.load(function () {
                fetch(piranha.baseUrl + "manager/api/post/list")
        ...
        remove: function (id) {
            ...
            piranha.alert.open({
                ...
                onConfirm: function () {
                    fetch(piranha.baseUrl + "manager/api/post/delete/" + id)
                    .then(function (response) { return response.json(); })
                    .then(function (result) {
            ...
            $(".sitemap-container").each(function (i, e) {
                $(e).nestable({
                    ...
                    callback: function (l, e) {
                        fetch(piranha.baseUrl + "manager/api/post/move", {
                            method: "post",
                            headers: {
